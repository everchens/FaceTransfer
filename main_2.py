...
def parse_args():
    ...
    parser.add_argument('--gan_type', type=str, default='wgan-gp', help='GAN loss type [gan / lsgan / wgan-gp]')
    ...
    parser.add_argument('--recon_c_w', type=float, default=10.0, help='weight of content reconstruction loss')
